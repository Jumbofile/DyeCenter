        ...
        try{
            ...
            for(int i = 0; i < gamesOnTable.size(); i++){
                ...
                htmlForPage = htmlForPage +
                        "<button formnovalidate onclick ='clearVals' class=\"game-card\" type=\"submit\" name = \"gamePressed\" data-hash=\""+ gamesOnTable.get(i).getHash() +"\" data-leader=\"" + gamesOnTable.get(i).getGameWinner() + "\" data-status=\""+ gamesOnTable.get(i).getStatus() + "\" "+
